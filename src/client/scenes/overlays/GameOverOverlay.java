...
import client.scenes.LevelScene;
...
public class GameOverOverlay {
    ...
    public void show() {
        ...
        enemiesKilled.addComponent(new TextComponent(font, "enemies killed: 0", new Vector4f(1, 1, 1, 1), 1.0f, 0.8f, "fixed"));
        ...
        bossesKilled.addComponent(new TextComponent(font, "bosses killed: 0", new Vector4f(1, 1, 1, 1), 1.0f, 0.8f, "fixed"));
