...
public class EnemySystem extends IteratingEntitySystem<Context> {
    ...
    public void shootAtPlayer(int enemyId) {
        ...
        nsm.spawn(Bullet.class, Bullet.serialize(enemyTransform.position.x, enemyTransform.position.y, minPosition.x + dx, minPosition.y + dy, enemyMovement.velocity.x, enemyMovement.velocity.y, ec.bulletSpeed, -1, 1, 3.0f));
    }
}