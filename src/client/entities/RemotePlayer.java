...
public class RemotePlayer extends Prefab {
    ...
    public void spawnCommon() {
        ...
        entity.addComponent(new NetworkDuplicateComponent(TransformComponent.class, PlayerStateComponent.class, ExperienceComponent.class, MovementInputComponent.class, PlayerKeysComponent.class, HealthComponent.class, PlayerUpgradeComponent.class));
    }
